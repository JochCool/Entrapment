...
execute if score $Game Tick matches 1 positioned -59 289 1 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned 21 289 1 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned -27 289 1 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned 53 289 1 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned -59 289 33 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned 21 289 33 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned -27 289 33 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned 53 289 33 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned -59 289 65 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned 21 289 65 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned -27 289 65 run function entrapment:arenas/prepare
execute if score $Game Tick matches 1 positioned 53 289 65 run function entrapment:arenas/prepare
...
execute if score $Game Tick matches 37 run data modify block -59 289 1 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[6]
execute if score $Game Tick matches 37 run setblock -59 289 1 redstone_block

execute if score $Game Tick matches 40 run data modify block 21 289 1 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[6]
execute if score $Game Tick matches 40 run setblock 21 289 1 redstone_block

# 1 1 0 structure block

execute if score $Game Tick matches 43 run data modify block -27 289 1 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[9]
execute if score $Game Tick matches 43 run setblock -27 289 1 redstone_block

execute if score $Game Tick matches 46 run data modify block 53 289 1 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[9]
execute if score $Game Tick matches 46 run setblock 53 289 1 redstone_block

# 0 1 1 structure block

execute if score $Game Tick matches 49 run data modify block -59 289 33 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[7]
execute if score $Game Tick matches 49 run setblock -59 289 33 redstone_block

execute if score $Game Tick matches 52 run data modify block 21 289 33 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[7]
execute if score $Game Tick matches 52 run setblock 21 289 33 redstone_block

# 1 1 1 structure block

execute if score $Game Tick matches 55 run data modify block -27 289 33 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[10]
execute if score $Game Tick matches 55 run setblock -27 289 33 redstone_block

execute if score $Game Tick matches 58 run data modify block 53 289 33 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[10]
execute if score $Game Tick matches 58 run setblock 53 289 33 redstone_block

# 0 1 2 structure block

execute if score $Game Tick matches 61 run data modify block -59 289 65 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[8]
execute if score $Game Tick matches 61 run setblock -59 289 65 redstone_block

execute if score $Game Tick matches 64 run data modify block 21 289 65 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[8]
execute if score $Game Tick matches 64 run setblock 21 289 65 redstone_block

# 1 1 2 structure block
 
execute if score $Game Tick matches 67 run data modify block -27 289 65 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[11]
execute if score $Game Tick matches 67 run setblock -27 289 65 redstone_block

execute if score $Game Tick matches 70 run data modify block 53 289 65 name set from entity @e[type=armor_stand,scores={Selected=1..},limit=1] ArmorItems[3].tag.files[11]
